<?php 
/*This page displays the receipt when merchant click on "View Details" button in the Daily Sales Report table */
...
<html>
    ...
    <body>
        ...
        <section class="receipt-container2">
            <center><br><h2>ORDER #<?php echo $order_id;?></h2><hr style='border-top:1px dashed black;width:60%;'></center>
            ...
            if($result->num_rows > 0) {
                while($row = $result -> fetch_assoc()){   
                    ...
                    echo "<tr><th>Customer: </th><td>" . $row['customer']. "</td></tr>";
                    echo "<tr><th>Customer Contact: </th><td>" . $row['cusContact']. "</td></tr>";
        ...
        <div style="text-align:right;"><button class="btn2" onclick ="location.href='merchant-reportDailySales.php';">Proceed</button></div>
    </section>
