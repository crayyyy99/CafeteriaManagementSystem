...
/*This page display the daily sales report  */
    ...
    <head>
        ...
        <script>
            ...
            $(document).ready(function(){
                $("#daily-sales").addClass("active-profile");
            });
    ...
    <body>
                    ...
                    <form id="session-form" method = "POST" action="">
                        ...
                        <select style="font-size:16px;" name = "session" size="1" onChange="this.form.submit()">
                            ...
                            <?php if((isset($_POST['session']))&&($_POST['session']=='Overall')) {
                                    ...
                                    $_SESSION['session3'] = 'Overall';
                                }
                                else if((isset($_SESSION['session3']))&&($_SESSION['session3']=='Overall')) {
                                    echo "selected='selected'"; 
                                    $_SESSION['session3'] = 'Overall';
                                }
                                else if( (isset($_POST['date-btn'])) && ($_SESSION['session3']=='Overall') ) {
                                    echo "selected='selected'"; 
                                    $_SESSION['session3'] = 'Overall';
                                }
                                else if( (isset($_POST['month-btn'])) && ($_SESSION['session3']=='Overall') ) {
                                    echo "selected='selected'"; 
                                    $_SESSION['session3'] = 'Overall';
                                }
                                ?>>Overall
                            ...
                            <?php if((isset($_POST['session']))&&($_POST['session']=='Morning')) {
                                    echo "selected='selected'";
                                    $_SESSION['session3'] = 'Morning';
                                }
                                else if((isset($_SESSION['session3']))&&($_SESSION['session3']=='Morning')) {
                                    echo "selected='selected'"; 
                                    $_SESSION['session3'] = 'Morning';
                                }
                                else if( (isset($_POST['date-btn'])) && ($_SESSION['session3']=='Morning') ) {
                                    echo "selected='selected'"; 
                                    $_SESSION['session3'] = 'Morning';
                                }
                                else if( (isset($_POST['month-btn'])) && ($_SESSION['session3']=='Morning') ) {
                                    echo "selected='selected'"; 
                                    $_SESSION['session3'] = 'Morning';
                                }
                                ?>>Morning
                                ...
                                <?php if((isset($_POST['session']))&&($_POST['session']=='Afternoon')) {
                                    echo "selected='selected'";
                                    $_SESSION['session3'] = 'Afternoon';
                                }
                                else if((isset($_SESSION['session3']))&&($_SESSION['session3']=='Afternoon')) {
                                    echo "selected='selected'"; 
                                    $_SESSION['session3'] = 'Afternoon';
                                }
                                else if( (isset($_POST['date-btn'])) && ($_SESSION['session3']=='Afternoon') ) {
                                    echo "selected='selected'"; 
                                    $_SESSION['session3'] = 'Afternoon';
                                }
                                else if( (isset($_POST['month-btn'])) && ($_SESSION['session3']=='Afternoon') ) {
                                    echo "selected='selected'"; 
                                    $_SESSION['session3'] = 'Afternoon';
                                }
                                ?>>Afternoon</option>
                                ...
                                <?php if((isset($_POST['session']))&&($_POST['session']=='Evening')) {
                                    echo "selected='selected'";
                                    $_SESSION['session3'] = 'Evening';
                                }
                                else if((isset($_SESSION['session3']))&&($_SESSION['session3']=='Evening')) {
                                    echo "selected='selected'"; 
                                    $_SESSION['session3'] = 'Evening';
                                }
                                else if( (isset($_POST['date-btn'])) && ($_SESSION['session3']=='Evening') ) {
                                    echo "selected='selected'"; 
                                    $_SESSION['session3'] = 'Evening';
                                }
                                else if( (isset($_POST['month-btn'])) && ($_SESSION['session3']=='Evening') ) {
                                    echo "selected='selected'"; 
                                    $_SESSION['session3'] = 'Evening';
                                }
                                ?>>Evening</option>
        ...
        <?php 
                    if(isset($_POST["session"])){
                        $_SESSION["session3"]=$_POST["session"];
                        include ("merchant-reportDailySalesTable.php");
                    }
                    else{
                        include ("merchant-reportDailySalesTable.php");
                    }
