    ...
    <head>
        ...
        <script>
            ...
            $(document).ready(function(){
                $("#monthly-sales").addClass("active-profile");
            });
    ...
    <body>
                    ...
                    <form id="session-form" method = "POST" action="">
                        ...
                        <select style="font-size:16px;" name = "session" size="1" onChange="this.form.submit()">
                            ...
                            <?php if((isset($_POST['session']))&&($_POST['session']=='Overall')) {
                                    ...
                                    $_SESSION['session4'] = 'Overall';
                                }
                                else if((isset($_SESSION['session4']))&&($_SESSION['session4']=='Overall')) {
                                    echo "selected='selected'"; 
                                    $_SESSION['session4'] = 'Overall';
                                }
                                else if( (isset($_POST['date-btn'])) && ($_SESSION['session4']=='Overall') ) {
                                    echo "selected='selected'"; 
                                    $_SESSION['session4'] = 'Overall';
                                }
                                else if( (isset($_POST['month-btn'])) && ($_SESSION['session4']=='Overall') ) {
                                    echo "selected='selected'"; 
                                    $_SESSION['session4'] = 'Overall';
                                }
                                ?>>Overall
                            ...
                            <?php if((isset($_POST['session']))&&($_POST['session']=='Morning')) {
                                    echo "selected='selected'";
                                    $_SESSION['session4'] = 'Morning';
                                }
                                else if((isset($_SESSION['session4']))&&($_SESSION['session4']=='Morning')) {
                                    echo "selected='selected'"; 
                                    $_SESSION['session4'] = 'Morning';
                                }
                                else if( (isset($_POST['date-btn'])) && ($_SESSION['session4']=='Morning') ) {
                                    echo "selected='selected'"; 
                                    $_SESSION['session4'] = 'Morning';
                                }
                                else if( (isset($_POST['month-btn'])) && ($_SESSION['session4']=='Morning') ) {
                                    echo "selected='selected'"; 
                                    $_SESSION['session4'] = 'Morning';
                                }
                                ?>>Morning
                                ...
                                <?php if((isset($_POST['session']))&&($_POST['session']=='Afternoon')) {
                                    echo "selected='selected'";
                                    $_SESSION['session4'] = 'Afternoon';
                                }
                                else if((isset($_SESSION['session4']))&&($_SESSION['session4']=='Afternoon')) {
                                    echo "selected='selected'"; 
                                    $_SESSION['session4'] = 'Afternoon';
                                }
                                else if( (isset($_POST['date-btn'])) && ($_SESSION['session4']=='Afternoon') ) {
                                    echo "selected='selected'"; 
                                    $_SESSION['session4'] = 'Afternoon';
                                }
                                else if( (isset($_POST['month-btn'])) && ($_SESSION['session4']=='Afternoon') ) {
                                    echo "selected='selected'"; 
                                    $_SESSION['session4'] = 'Afternoon';
                                }
                                ?>>Afternoon</option>
                                ...
                                <?php if((isset($_POST['session']))&&($_POST['session']=='Evening')) {
                                    echo "selected='selected'";
                                    $_SESSION['session4'] = 'Evening';
                                }
                                else if((isset($_SESSION['session4']))&&($_SESSION['session4']=='Evening')) {
                                    echo "selected='selected'"; 
                                    $_SESSION['session4'] = 'Evening';
                                }
                                else if( (isset($_POST['date-btn'])) && ($_SESSION['session4']=='Evening') ) {
                                    echo "selected='selected'"; 
                                    $_SESSION['session4'] = 'Evening';
                                }
                                else if( (isset($_POST['month-btn'])) && ($_SESSION['session4']=='Evening') ) {
                                    echo "selected='selected'"; 
                                    $_SESSION['session4'] = 'Evening';
                                }
                                ?>>Evening</option>
        ...
        <?php 
                    if(isset($_POST["session"])){
                        $_SESSION["session4"]=$_POST["session"];
                        include ("merchant-reportMonthlySalesTable.php");
                    }
                    else{
                        include ("merchant-reportMonthlySalesTable.php");
                    }
