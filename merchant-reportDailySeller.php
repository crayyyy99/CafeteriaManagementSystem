...
/*This page display the daily best seller report  */
    ...
    <head>
        ...
        <script>
            ...
            $(document).ready(function(){
                $("#daily-bseller").addClass("active-profile");
            });
    ...
    <body>
        ...
        <section class="report-container">
            ...
            <section class="profile-nav-element-container">
                <section class="history-container" style="padding: 10px 20px;">        
                    <h2>Daily Best Seller Report</h2>

                     <!--Allow merchant to select session to view daily sales report-->
                    ...
                    <form id="session-form" method = "POST" action="">
                        ...
                        <select style="font-size:16px;" name = "session" size="1" onChange="this.form.submit()">
                            ...
                            <?php if((isset($_POST['session']))&&($_POST['session']=='Overall')) {
                                    ...
                                    $_SESSION['session5'] = 'Overall';
                                }
                                else if((isset($_SESSION['session5']))&&($_SESSION['session5']=='Overall')) {
                                    echo "selected='selected'"; 
                                    $_SESSION['session5'] = 'Overall';
                                }
                                else if( (isset($_POST['date-btn'])) && ($_SESSION['session5']=='Overall') ) {
                                    echo "selected='selected'"; 
                                    $_SESSION['session5'] = 'Overall';
                                }
                                else if( (isset($_POST['month-btn'])) && ($_SESSION['session5']=='Overall') ) {
                                    echo "selected='selected'"; 
                                    $_SESSION['session5'] = 'Overall';
                                }
                                ?>>Overall
                            ...
                            <?php if((isset($_POST['session']))&&($_POST['session']=='Morning')) {
                                    echo "selected='selected'";
                                    $_SESSION['session5'] = 'Morning';
                                }
                                else if((isset($_SESSION['session3']))&&($_SESSION['session5']=='Morning')) {
                                    echo "selected='selected'"; 
                                    $_SESSION['session5'] = 'Morning';
                                }
                                else if( (isset($_POST['date-btn'])) && ($_SESSION['session5']=='Morning') ) {
                                    echo "selected='selected'"; 
                                    $_SESSION['session5'] = 'Morning';
                                }
                                else if( (isset($_POST['month-btn'])) && ($_SESSION['session5']=='Morning') ) {
                                    echo "selected='selected'"; 
                                    $_SESSION['session5'] = 'Morning';
                                }
                                ?>>Morning
                                ...
                                <?php if((isset($_POST['session']))&&($_POST['session']=='Afternoon')) {
                                    echo "selected='selected'";
                                    $_SESSION['session5'] = 'Afternoon';
                                }
                                else if((isset($_SESSION['session5']))&&($_SESSION['session5']=='Afternoon')) {
                                    echo "selected='selected'"; 
                                    $_SESSION['session5'] = 'Afternoon';
                                }
                                else if( (isset($_POST['date-btn'])) && ($_SESSION['session5']=='Afternoon') ) {
                                    echo "selected='selected'"; 
                                    $_SESSION['session5'] = 'Afternoon';
                                }
                                else if( (isset($_POST['month-btn'])) && ($_SESSION['session5']=='Afternoon') ) {
                                    echo "selected='selected'"; 
                                    $_SESSION['session5'] = 'Afternoon';
                                }
                                ?>>Afternoon</option>
                                ...
                                <?php if((isset($_POST['session']))&&($_POST['session']=='Evening')) {
                                    echo "selected='selected'";
                                    $_SESSION['session5'] = 'Evening';
                                }
                                else if((isset($_SESSION['session5']))&&($_SESSION['session5']=='Evening')) {
                                    echo "selected='selected'"; 
                                    $_SESSION['session5'] = 'Evening';
                                }
                                else if( (isset($_POST['date-btn'])) && ($_SESSION['session5']=='Evening') ) {
                                    echo "selected='selected'"; 
                                    $_SESSION['session5'] = 'Evening';
                                }
                                else if( (isset($_POST['month-btn'])) && ($_SESSION['session5']=='Evening') ) {
                                    echo "selected='selected'"; 
                                    $_SESSION['session5'] = 'Evening';
                                }
                                ?>>Evening</option>
        ...
        ?>
                    ...
                    <form method = "POST" action="">
                        Select Date: <input type="date" name="searchDate" id="searchDate" >                      
        ...
        <?php 
                    if(isset($_POST["session"])){
                        $_SESSION["session5"]=$_POST["session"];
                        include ("merchant-reportDailySellerTable.php");
                    }
                    else{
                        include ("merchant-reportDailySellerTable.php");
                    }
