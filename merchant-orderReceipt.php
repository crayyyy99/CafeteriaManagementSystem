<?php 
/*This page displays the receipt when merchant click on "View Details" button in the Order table */
...
<html>
    ...
    <body>
        ...
        <div style="text-align:right;"><button class="btn2" onclick ="location.href='merchant-order.php';">Proceed</button></div>
    </section>
