...
$sql = "SELECT * FROM logins WHERE logins.email = '$email'";
...
//Verify the password by hashing the password input to match with hashed pwd in database
    if (password_verify($pwd, $db_pwd)) {
        if($permission == "Customer"){
            ...
            session_unset();
            echo "<meta http-equiv=\"refresh\" content=\"2;URL=merchant-login.php\">";    
        }
        else{
            ...
            echo "<meta http-equiv=\"refresh\" content=\"2;URL=merchant-home.php\">";    
        }  
    }
    else{
